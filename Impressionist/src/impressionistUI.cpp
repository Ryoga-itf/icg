...
//-----------------------------------------------------------
// Updates the brush opacity to use from the value of the alpha
// slider
...
Fl_Menu_Item ImpressionistUI::brushTypeMenu[NUM_BRUSH_TYPE + 1] = {
    ...
    {"Scattered Points", FL_ALT + 'x', (Fl_Callback *)ImpressionistUI::cb_brushChoice, (void *)BRUSH_SCATTERED_POINTS},
    {"Scattered Circles", FL_ALT + 'y', (Fl_Callback *)ImpressionistUI::cb_brushChoice,
...
void ImpressionistUI::cb_filter_kernel(Fl_Menu_ *o, void *v) {
    ImpressionistDoc *pDoc = whoami(o)->getDocument();
    if (pDoc->m_ucPainting != NULL) {
        memcpy(pDoc->m_ucPreviewBackup, pDoc->m_ucPainting, pDoc->m_nPaintWidth * pDoc->m_nPaintHeight * 3);
...
void ImpressionistUI::applyFilter(void) {
    m_pDoc->applyFilter(m_pDoc->m_ucPreviewBackup, m_pDoc->m_nPaintWidth, m_pDoc->m_nPaintHeight, m_pDoc->m_ucPainting,
