...
void Camera::setEye(const Vec3d &eye) { this->eye = eye; }
...
void Camera::setLook(const Vec3d &viewDir, const Vec3d &upDir) {
...
bool Camera::setLookSimple(const Vec3d &v, const Vec3d &pos) {
