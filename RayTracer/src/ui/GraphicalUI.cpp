...
void GraphicalUI::cb_stop(Fl_Widget *o, void *v) { stopTrace = true; }
...
// menu definition
Fl_Menu_Item GraphicalUI::menuitems[] = {{"&File", 0, 0, 0, FL_SUBMENU},
...
void GraphicalUI::stopTracing() {
    if (stopTrace)
        return; // Only one person can be waiting at a time
