...
#include "ui/debuggingWindow.h"

inline void DebuggingWindow::cb_Normal_i(Fl_Menu_ *, void *) { m_debuggingView->setShadingMode(DebuggingView::NORMAL); }
...
inline void DebuggingWindow::cb_High_i(Fl_Menu_ *, void *) { m_debuggingView->setQuality(DebuggingView::HIGH_QUALITY); }
...
inline void DebuggingWindow::cb_Low_i(Fl_Menu_ *, void *) { m_debuggingView->setQuality(DebuggingView::LOW_QUALITY); }
void DebuggingWindow::cb_Low(Fl_Menu_ *o, void *v) { ((DebuggingWindow *)(o->parent()->user_data()))->cb_Low_i(o, v); }

inline void DebuggingWindow::cb_Poor_i(Fl_Menu_ *, void *) { m_debuggingView->setQuality(DebuggingView::POOR_QUALITY); }
...
void DebuggingWindow::cb_Use(Fl_Menu_ *o, void *v) { ((DebuggingWindow *)(o->parent()->user_data()))->cb_Use_i(o, v); }
