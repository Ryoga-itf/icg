...
class MaterialParameter {
  public:
    explicit MaterialParameter(const Vec3d &par) : _value(par), _textureMap(0) {}
...
class Material {
  ...
  public:
    Material()
        : _ke(Vec3d(0.0, 0.0, 0.0)), _ka(Vec3d(0.0, 0.0, 0.0)), _ks(Vec3d(0.0, 0.0, 0.0)), _kd(Vec3d(0.0, 0.0, 0.0)),
          _kr(Vec3d(0.0, 0.0, 0.0)), _kt(Vec3d(0.0, 0.0, 0.0)), _shininess(0.0), _index(1.0) {}

    Material(const Vec3d &e, const Vec3d &a, const Vec3d &s, const Vec3d &d, const Vec3d &r, const Vec3d &t, double sh,
             double in)
        : _ke(e), _ka(a), _ks(s), _kd(d), _kr(r), _kt(t), _shininess(Vec3d(sh, sh, sh)), _index(Vec3d(in, in, in)) {}
