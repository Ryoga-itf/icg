...
template <class T> Vec<T>::Vec(int size, bool zeroElements) {
    numElements = size;
    n = new T[size];
...
template <class T> Vec<T>::~Vec() { delete[] n; }

template <class T> void Vec<T>::resize(int size, bool zeroElements) {
    if (numElements != size) {
        numElements = size;
        delete[] n;
...
template <class T> void Vec<T>::zeroElements() { memset(n, 0, numElements * sizeof(T)); }
...
template <class T> Vec<T> &Vec<T>::operator*=(const T d) {
    for (int i = 0; i < numElements; i++)
        n[i] *= d;
...
template <class T> double Vec<T>::length2() const {
    double result = 0.0;
...
template <class T> double Vec<T>::length() const { return sqrt(length2()); }

template <class T> void Vec<T>::normalize() {
    double len = length();
    assert(len != 0);
...
template <class T> bool Vec<T>::iszero() {
    for (int i = 0; i < numElements; i++)
        if (n[i] != 0)
            return false;
...
template <class T> std::istream &operator>>(std::istream &is, const Vec<T> &a) { return is; }
...
template <class T> inline Vec3<T> operator-(const Vec3<T> &v) { return Vec3<T>(-v.n[0], -v.n[1], -v.n[2]); }

template <class T> inline Vec3<T> operator*(const Vec3<T> &a, const double d) {
    return Vec3<T>(a.n[0] * d, a.n[1] * d, a.n[2] * d);
}

template <class T> inline Vec3<T> operator*(const double d, const Vec3<T> &a) { return a * d; }
...
template <class T> inline Vec3<T> operator*(const Vec3<T> &v, Mat4<T> &a) { return a.transpose() * v; }
...
template <class T> inline Vec3<T> operator*(const Vec3<T> &v, const Mat3<T> &a) { return a.transpose() * v; }
...
template <class T> inline Vec3<T> operator^(const Vec3<T> &a, const Vec3<T> &b) {
    return Vec3<T>(a.n[1] * b.n[2] - a.n[2] * b.n[1], a.n[2] * b.n[0] - a.n[0] * b.n[2],
...
template <class T> inline bool operator!=(const Vec3<T> &a, const Vec3<T> &b) { return !(a == b); }
...
template <class T> inline Vec4<T> operator-(const Vec4<T> &v) { return Vec4<T>(-v.n[0], -v.n[1], -v.n[2], -v.n[3]); }

template <class T> inline Vec4<T> operator*(const Vec4<T> &a, const double d) {
    return Vec4<T>(a.n[0] * d, a.n[1] * d, a.n[2] * d, a.n[3] * d);
}

template <class T> inline Vec4<T> operator*(const double d, const Vec4<T> &a) { return a * d; }
...
template <class T> inline Vec4<T> operator*(const Vec4<T> &v, Mat4<T> &a) { return a.transpose() * v; }
...
template <class T> inline bool operator!=(const Vec4<T> &a, const Vec4<T> &b) { return !(a == b); }
...
template <class T> inline Vec4<T> minimum(const Vec4<T> &a, const Vec4<T> &b) {
    return Vec4<T>(min(a.n[0], b.n[0]), min(a.n[1], b.n[1]), min(a.n[2], b.n[2]), min(a.n[3], b.n[3]));
}

template <class T> inline Vec4<T> maximum(const Vec4<T> &a, const Vec4<T> &b) {
    return Vec4<T>(max(a.n[0], b.n[0]), max(a.n[1], b.n[1]), max(a.n[2], b.n[2]), max(a.n[3], b.n[3]));
}
...
template <class T> Vec3<T> vec4to3(Vec4<T> &v) { return Vec3<T>(v[0], v[1], v[2]); }
