...
IndicatorWindow::IndicatorWindow(int x, int y, int w, int h, const char *lable)
    : Fl_Double_Window(x, y, w, h, lable), m_fMin(0.0f), m_fMax(1.0f), m_fRangeMarkerMin(0.0f), m_fRangeMarkerMax(0.0f),
      m_bRangeMarkerEnabled(false), m_fFloatingIndicator(0.0f), m_iSelectedIndicator(-1) {
    box(FL_NO_BOX);
}
...
void IndicatorWindow::clearIndicators() { m_fvIndicators.clear(); }
...
float IndicatorWindow::floatingIndicator() const { return m_fFloatingIndicator; }

bool IndicatorWindow::floatingIndicatorSnapped() const { return (m_iSelectedIndicator >= 0); }
...
bool IndicatorWindow::rangeMarkerEnabled() const { return m_bRangeMarkerEnabled; }

void IndicatorWindow::rangeMarkerEnabled(bool RangeMarkerEnabled) { m_bRangeMarkerEnabled = RangeMarkerEnabled; }
