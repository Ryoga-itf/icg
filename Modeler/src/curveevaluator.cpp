...
void CurveEvaluator::handleEdgeCases(const std::vector<Point> &ptvCtrlPts, std::vector<Point> &ptvEvaluatedCurvePts,
                                     const float &fAniLength, const float default_val) {
