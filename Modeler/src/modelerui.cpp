...
inline void ModelerUI::cb_openAniScript_i(Fl_Menu_ *, void *) {
    const char *szFileName =
        fileDialog(Fl_Native_File_Chooser::BROWSE_FILE, "Animation Script (*.ani)\t*.ani", "Open Animation Script");
...
inline void ModelerUI::cb_saveAniScript_i(Fl_Menu_ *, void *) {
    const char *szFileName = fileDialog(Fl_Native_File_Chooser::BROWSE_SAVE_FILE, "Animation Script (*.ani)\t*.ani",
...
inline void ModelerUI::cb_saveImageFile_i(Fl_Menu_ *, void *) {
    const char *szFilename =
        fileDialog(Fl_Native_File_Chooser::BROWSE_SAVE_FILE,
                   "PNG Image File (*.png)\t*.png\nJPEG Image File (*.jpg)\t*.jpg", "Save Frame As");
    if (!szFilename)
        return;
...
inline void ModelerUI::cb_saveMovie_i(Fl_Menu_ *, void *) {
    const char *szFilename =
        fileDialog(Fl_Native_File_Chooser::BROWSE_SAVE_FILE,
                   "PNG Image File (*.png)\t*.png\nJPEG Image File (*.jpg)\t*.jpg", "Save Movie As");
...
void ModelerUI::cb_saveMovie(Fl_Menu_ *o, void *v) { ((ModelerUI *)(o->parent()->user_data()))->cb_saveMovie_i(o, v); }
...
void ModelerUI::cb_exit(Fl_Menu_ *o, void *v) { ((ModelerUI *)(o->parent()->user_data()))->cb_exit_i(o, v); }
...
void ModelerUI::cb_hide(Fl_Window *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_hide_i(o, v); }
...
void ModelerUI::cb_normal(Fl_Menu_ *o, void *v) { ((ModelerUI *)(o->parent()->user_data()))->cb_normal_i(o, v); }
...
void ModelerUI::cb_flat(Fl_Menu_ *o, void *v) { ((ModelerUI *)(o->parent()->user_data()))->cb_flat_i(o, v); }
...
void ModelerUI::cb_wireframe(Fl_Menu_ *o, void *v) { ((ModelerUI *)(o->parent()->user_data()))->cb_wireframe_i(o, v); }
...
void ModelerUI::cb_high(Fl_Menu_ *o, void *v) { ((ModelerUI *)(o->parent()->user_data()))->cb_high_i(o, v); }
...
void ModelerUI::cb_medium(Fl_Menu_ *o, void *v) { ((ModelerUI *)(o->parent()->user_data()))->cb_medium_i(o, v); }
...
void ModelerUI::cb_low(Fl_Menu_ *o, void *v) { ((ModelerUI *)(o->parent()->user_data()))->cb_low_i(o, v); }
...
void ModelerUI::cb_poor(Fl_Menu_ *o, void *v) { ((ModelerUI *)(o->parent()->user_data()))->cb_poor_i(o, v); }
...
void ModelerUI::cb_aniLen(Fl_Menu_ *o, void *v) { ((ModelerUI *)(o->parent()->user_data()))->cb_aniLen_i(o, v); }
...
inline void ModelerUI::cb_fps_i(Fl_Slider *, void *) { fps(m_psldrFPS->value()); }

void ModelerUI::cb_fps(Fl_Slider *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_fps_i(o, v); }
...
void ModelerUI::cb_browser(Fl_Browser *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_browser_i(o, v); }
...
void ModelerUI::cb_tab(Fl_Tabs *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_tab_i(o, v); }
...
void ModelerUI::cb_graphWidget(GraphWidget *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_graphWidget_i(o, v); }
...
void ModelerUI::cb_zoomAll(Fl_Button *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_zoomAll_i(o, v); }
...
void ModelerUI::cb_curveType(Fl_Choice *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_curveType_i(o, v); }
...
void ModelerUI::cb_wrap(Fl_Light_Button *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_wrap_i(o, v); }
...
void ModelerUI::cb_setCamKeyFrame(Fl_Button *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_setCamKeyFrame_i(o, v); }
...
inline void ModelerUI::cb_playStartSlider_i(Fl_Slider *, void *) { playStartTime(m_psldrPlayStart->value()); }

void ModelerUI::cb_playStartSlider(Fl_Slider *o, void *v) {
    ((ModelerUI *)(o->user_data()))->cb_playStartSlider_i(o, v);
}

inline void ModelerUI::cb_playEndSlider_i(Fl_Slider *, void *) { playEndTime(m_psldrPlayEnd->value()); }

void ModelerUI::cb_playEndSlider(Fl_Slider *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_playEndSlider_i(o, v); }

inline void ModelerUI::cb_timeSlider_i(Fl_Slider *, void *) { currTime(m_psldrTimeSlider->value()); }

void ModelerUI::cb_timeSlider(Fl_Slider *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_timeSlider_i(o, v); }
...
void ModelerUI::cb_play(Fl_Button *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_play_i(o, v); }
...
void ModelerUI::cb_pause(Fl_Button *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_pause_i(o, v); }

inline void ModelerUI::cb_stepBack_i(Fl_Button *, void *) { currTime(currTime() - 1.0f / (float)m_iFps); }

void ModelerUI::cb_stepBack(Fl_Button *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_stepBack_i(o, v); }

inline void ModelerUI::cb_stepForw_i(Fl_Button *, void *) { currTime(currTime() + 1.0f / (float)m_iFps); }

void ModelerUI::cb_stepForw(Fl_Button *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_stepForw_i(o, v); }
...
void ModelerUI::cb_clearSim(Fl_Button *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_clearSim_i(o, v); }

inline void ModelerUI::cb_loop_i(Fl_Light_Button *, void *) {}

void ModelerUI::cb_loop(Fl_Light_Button *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_loop_i(o, v); }

inline void ModelerUI::cb_simulate_i(Fl_Light_Button *o, void *) {}

void ModelerUI::cb_simulate(Fl_Light_Button *o, void *v) { ((ModelerUI *)(o->user_data()))->cb_simulate_i(o, v); }
...
Fl_Box *ModelerUI::labelBox(int nBox) { return (Fl_Box *)m_ppckPack->child(nBox * 2); }

Fl_Value_Slider *ModelerUI::valueSlider(int iSlider) { return (Fl_Value_Slider *)m_ppckPack->child(iSlider * 2 + 1); }
...
float ModelerUI::currTime() const { return m_pwndGraphWidget->currTime(); }
...
float ModelerUI::endTime() const { return m_pwndGraphWidget->endTime(); }
...
float ModelerUI::playStartTime() const { return m_fPlayStartTime; }
...
float ModelerUI::playEndTime() const { return m_fPlayEndTime; }
...
Curve *ModelerUI::getCurve(int iControl) { return m_pwndGraphWidget->curve(iControl); }
...
void ModelerUI::setValueChangedCallback(ValueChangedCallback *pcbf) { m_pcbfValueChangedCallback = pcbf; }
...
int ModelerUI::fps() { return m_iFps; }

void ModelerUI::fps(const int iFps) { m_iFps = iFps; }

ModelerUI::ModelerUI()
    : m_iCurrControlCount(0), m_pcbfValueChangedCallback(NULL), m_iFps(30), m_bAnimating(false), m_bSaveMovie(false),
...
void ModelerUI::show() {
    m_pwndMainWnd->resize(30, 30, m_pwndMainWnd->w(), m_pwndMainWnd->h());
    m_pwndMainWnd->show();

    // if the user specifies a resolution
    if (userResolution) {
        m_pwndModelerWnd->resize(40 + m_pwndMainWnd->w(), 30, ModelerUI::userWidth, ModelerUI::userHeight);
        m_pwndModelerWnd->show();
    }
    // else use the default resolution
    else {
        m_pwndModelerWnd->resize(40 + m_pwndMainWnd->w(), 30, m_pwndModelerWnd->w(), m_pwndModelerWnd->h());
        m_pwndModelerWnd->show();
    }
